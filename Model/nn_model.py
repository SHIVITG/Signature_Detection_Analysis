...
# This file contains code of the model: "back propogation neural network".       #

# -------------Basic Requirements for executing a neural network-----------------#
# Functions defined in NeuralNetwork Class:_init_ ,feedforward,separate_batches, # 
# update_batches,backpropagation,evaluate,sgd and cost_derivative.               #
# Two more functions are : sigmoid & sigmoid_prime                               #
#--------------------------------------------------------------------------------#
